...
func (s *QueueTestSuite) TestDefaultRedisQueue() {
	...
	s.mockConfig.On("GetString", "queue.connections.redis.database").Return("default").Times(7)
	...
	s.mockConfig.On("GetInt", "database.redis.default.port").Return(s.redisDocker.GetPort("6379/tcp")).Times(7)
...
func (s *QueueTestSuite) TestDelayRedisQueue() {
	...
	s.mockConfig.On("GetString", "queue.connections.redis.driver").Return("custom")
	s.mockConfig.On("Get", "queue.connections.redis.via").Return(func() (contractsqueue.Driver, error) { return s.redis, nil })
	s.mockConfig.On("GetString", "queue.connections.redis.database").Return("default").Times(9)
	s.mockConfig.On("GetString", "database.redis.default.host").Return("localhost")
	s.mockConfig.On("GetString", "database.redis.default.password").Return("")
	s.mockConfig.On("GetInt", "database.redis.default.port").Return(s.redisDocker.GetPort("6379/tcp")).Times(9)
	s.mockConfig.On("GetInt", "database.redis.default.database").Return(0)
	s.mockConfig.On("GetString", "queue.failed.database").Return("database")
	s.mockConfig.On("GetString", "queue.failed.table").Return("failed_jobs")
...
func (s *QueueTestSuite) TestCustomRedisQueue() {
	...
	s.mockConfig.On("GetString", "app.name").Return("goravel")
	s.mockConfig.On("GetString", "queue.connections.custom.queue", "default").Return("default").Times(5)
	...
	s.mockConfig.On("GetString", "queue.connections.custom.database").Return("default").Times(5)
	s.mockConfig.On("GetString", "database.redis.default.host").Return("localhost")
	s.mockConfig.On("GetString", "database.redis.default.password").Return("")
	s.mockConfig.On("GetInt", "database.redis.default.port").Return(s.redisDocker.GetPort("6379/tcp")).Times(5)
	s.mockConfig.On("GetInt", "database.redis.default.database").Return(0)
	s.mockConfig.On("GetString", "queue.failed.database").Return("database")
	s.mockConfig.On("GetString", "queue.failed.table").Return("failed_jobs")
...
func (s *QueueTestSuite) TestErrorRedisQueue() {
	...
	s.mockConfig.On("GetString", "queue.connections.redis.driver").Return("custom")
	s.mockConfig.On("Get", "queue.connections.redis.via").Return(func() (contractsqueue.Driver, error) { return s.redis, nil })
	s.mockConfig.On("GetString", "queue.connections.redis.database").Return("default").Times(11)
	s.mockConfig.On("GetString", "database.redis.default.host").Return("localhost")
	s.mockConfig.On("GetString", "database.redis.default.password").Return("")
	s.mockConfig.On("GetInt", "database.redis.default.port").Return(s.redisDocker.GetPort("6379/tcp")).Times(11)
	s.mockConfig.On("GetInt", "database.redis.default.database").Return(0)
	s.mockConfig.On("GetString", "queue.failed.database").Return("database")
	s.mockConfig.On("GetString", "queue.failed.table").Return("failed_jobs")
...
func (s *QueueTestSuite) TestChainRedisQueue() {
	...
	s.mockConfig.On("GetString", "queue.connections.redis.driver").Return("custom")
	s.mockConfig.On("Get", "queue.connections.redis.via").Return(func() (contractsqueue.Driver, error) { return s.redis, nil })
	s.mockConfig.On("GetString", "queue.connections.redis.database").Return("default").Twice()
	s.mockConfig.On("GetString", "database.redis.default.host").Return("localhost")
	s.mockConfig.On("GetString", "database.redis.default.password").Return("")
	s.mockConfig.On("GetInt", "database.redis.default.port").Return(s.redisDocker.GetPort("6379/tcp")).Twice()
	s.mockConfig.On("GetInt", "database.redis.default.database").Return(0)
	s.mockConfig.On("GetString", "queue.failed.database").Return("database")
	s.mockConfig.On("GetString", "queue.failed.table").Return("failed_jobs")
