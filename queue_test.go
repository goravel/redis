...
func (s *QueueTestSuite) TestDefaultRedisQueue() {
	...
	s.mockConfig.EXPECT().GetString("database.redis.default.host").Return("localhost").Times(2)
	s.mockConfig.EXPECT().GetString("database.redis.default.username").Return("").Times(2)
	s.mockConfig.EXPECT().GetString("database.redis.default.password").Return("").Times(2)
	s.mockConfig.EXPECT().GetInt("database.redis.default.database").Return(0).Times(2)
...
func (s *QueueTestSuite) TestCustomRedisQueue() {
	...
	s.mockConfig.EXPECT().GetString("app.name").Return("goravel").Times(3)
	s.mockConfig.EXPECT().GetString("queue.connections.custom.queue", "default").Return("default").Times(2)
