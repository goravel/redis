...
func (s *QueueTestSuite) TestDefaultRedisQueue() {
	...
	s.mockConfig.EXPECT().GetString("queue.connections.redis.queue", "default").Return("default").Times(2)
	s.mockConfig.EXPECT().GetString("queue.connections.redis.driver").Return("custom").Times(3)
	s.mockConfig.EXPECT().Get("queue.connections.redis.via").Return(func() (contractsqueue.Driver, error) { return s.redis, nil }).Times(3)
	/*s.mockConfig.EXPECT().GetString("database.redis.default.host").Return("localhost").Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.username").Return("").Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.password").Return("").Times(1)
	s.mockConfig.EXPECT().GetInt("database.redis.default.database").Return(0).Times(1)*/
...
func (s *QueueTestSuite) TestDelayRedisQueue() {
	s.mockConfig.EXPECT().GetString("queue.default").Return("redis").Times(3)
	s.mockConfig.EXPECT().GetString("app.name").Return("goravel").Times(3)
	//s.mockConfig.EXPECT().GetString("queue.connections.redis.queue", "default").Return("default").Times(1)
	s.mockConfig.EXPECT().GetString("queue.connections.redis.driver").Return("custom").Times(2)
	s.mockConfig.EXPECT().Get("queue.connections.redis.via").Return(func() (contractsqueue.Driver, error) { return s.redis, nil }).Times(2)
	/*s.mockConfig.EXPECT().GetString("database.redis.default.host").Return("localhost").Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.username").Return("").Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.password").Return("").Times(1)
	s.mockConfig.EXPECT().GetInt("database.redis.default.database").Return(0).Times(1)*/
...
func (s *QueueTestSuite) TestCustomRedisQueue() {
	...
	s.mockConfig.EXPECT().GetString("app.name").Return("goravel").Times(3)
	s.mockConfig.EXPECT().GetString("queue.connections.custom.queue", "default").Return("default").Times(1)
	s.mockConfig.EXPECT().GetString("queue.connections.custom.driver").Return("custom").Times(2)
	s.mockConfig.EXPECT().Get("queue.connections.custom.via").Return(func() (contractsqueue.Driver, error) { return s.redis, nil }).Times(2)
	/*s.mockConfig.EXPECT().GetString("database.redis.default.host").Return("localhost").Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.username").Return("").Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.password").Return("").Times(1)
	s.mockConfig.EXPECT().GetInt("database.redis.default.database").Return(0).Times(1)*/
...
func (s *QueueTestSuite) TestErrorRedisQueue() {
	...
	/*s.mockConfig.EXPECT().GetString("queue.connections.redis.queue", "default").Return("default").Times(1)
	s.mockConfig.EXPECT().GetString("queue.connections.redis.driver").Return("custom").Times(1)
	s.mockConfig.EXPECT().Get("queue.connections.redis.via").Return(func() (contractsqueue.Driver, error) { return s.redis, nil }).Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.host").Return("localhost").Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.username").Return("").Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.password").Return("").Times(1)
	s.mockConfig.EXPECT().GetInt("database.redis.default.database").Return(0).Times(1)*/
...
func (s *QueueTestSuite) TestChainRedisQueue() {
	s.mockConfig.EXPECT().GetString("queue.default").Return("redis").Times(3)
	s.mockConfig.EXPECT().GetString("app.name").Return("goravel").Times(3)
	s.mockConfig.EXPECT().GetString("queue.connections.redis.queue", "default").Return("default").Times(3)
	s.mockConfig.EXPECT().GetString("queue.connections.redis.driver").Return("custom").Times(3)
	s.mockConfig.EXPECT().Get("queue.connections.redis.via").Return(func() (contractsqueue.Driver, error) { return s.redis, nil }).Times(3)
	/*s.mockConfig.EXPECT().GetString("database.redis.default.host").Return("localhost").Times(1)
	s.mockConfig.EXPECT().GetString("database.redis.default.username").Return("").Times(1)
